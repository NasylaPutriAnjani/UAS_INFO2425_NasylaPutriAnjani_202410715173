...
?>
<div id="page-admin_analytics" class="page active">
    ...
    <aside class="dash-sidebar admin-sidebar">
      ...
      <nav class="sidebar-nav" style="flex:1">
        <div class="sidebar-group">
          ...
          <button class="sidebar-item active"><span class="si">📈</span> Analitik</button>
        </div>
        <div class="sidebar-group">
        ...
        <div class="sidebar-group">
          ...
          <button class="sidebar-item" onclick="showPage('account_settings')"><span class="si">⚙️</span> Pengaturan Akun</button>
